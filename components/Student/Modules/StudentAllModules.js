...
const StudentAllModules = ({ modules }) => {
    return (
                        ...
                        modules?.map((cord_module, index) => {
                            ...
                            return (
                                <tr className="" key={index}>
                                    ...
                                    <td className="capitalize p-3 whitespace-nowrap border-b">
                                        <span>
                                            <div>{cord_module.module.code}</div>
                                        </span>
                                    </td>
                                    <td className="capitalize p-3 whitespace-nowrap border-b">
                                        <span>
                                    ...
                                    <td className="capitalize p-3 whitespace-nowrap border-b">
                                        <span>
                                            <div>
                                                {cord_module.module.credit_hour}
                                            </div>
                                        </span>
                                    </td>
...
export default StudentAllModules;
